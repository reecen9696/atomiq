...
pub struct StorageConfig {
    ...
    /// Maximum storage size in MB (None = unlimited, Some(n) = prune when DB exceeds n MB)
    /// Smarter than block count - adapts to actual data size
    /// Examples: Some(20_000) = 20GB limit, Some(5_000) = 5GB limit
...
impl Default for StorageConfig {
    fn default() -> Self {
        Self {
            ...
            max_storage_size_mb: None,  // Unlimited by default
        }
    }
}
    ...
    pub fn high_performance() -> Self {
        Self {
            ...
            storage: StorageConfig {
                ...
                max_storage_size_mb: None,  // Unlimited for testing
                ..Default::default()
            },
            ..Default::default()
        }
    ...
    pub fn production() -> Self {
        Self {
            ...
            storage: StorageConfig {
                ...
                max_storage_size_mb: None,  // Unlimited in production by default
            },
