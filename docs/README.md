# Atomiq Blockchain Documentation

Welcome to the Atomiq blockchain documentation! This directory contains comprehensive guides and reference materials.
...
- **Test**: `cargo test`
- **Run**: `cargo run --release --bin atomiq-unified`
- **Docs**: `cargo doc --open`
- **Deploy**: `cd deployment/docker && docker-compose up -d`

## Project Structure

See [Main README](../README.md) for complete project structure.
